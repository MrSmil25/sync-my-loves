...
import { exportTransactions } from "@/lib/finance-export";
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button
            ...
            title={rows.length === 0 ? "Belum ada data untuk diekspor" : undefined}
            onClick={async () => {
              setExporting(true);
              try {
                await exportTransactions(rows, { from, to });
          ...
          >
            {exporting ? (
              ...
              <>
                <Download className="size-4" /> Export Transaksi
              </>
            )}
          </Button>
          {canManage && (
